...
## Installation 
 To install `dissim`, download the `dissim-0.1.2-py3-none-any.whl` [file](https://github.com/nkusharoraa/dissim/raw/main/dissim-0.1.2-py3-none-any.whl) from the root folder of the repository and run `pip install ./dissim-0.1.2-py3-none-any.whl` in the same folder.
## Usage
